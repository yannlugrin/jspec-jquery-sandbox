...
This command add `jspec.jquery.sandbox.js' file into your `spec/support'
folder and create `spec/sandbox.html' file.
...
add iframe with sandbox source.
  ...
  <script>
    function runSuites() {
  ...
    <iframe id="sandbox" name="sandbox" src="./sandbox.html" style="display:none"></iframe>
  </body>
  ...

=== install manually

Just copy `jspec.jquery.sandbox.js' file from lib folder to your project
`spec/support' folder, and `sandbox.htm' file to your `spec' folder.
